...
var (
	...
	ErrCacheSourceSizeMismatch = errors.New("cache source size does not match file metadata")
	ErrCacheDirInUse           = errors.New("file cache directory is already in use")
	ErrCacheClosed             = errors.New("file cache is closed")
	ErrCacheLockUnsupported    = errors.New("file cache directory locking is unsupported")
